...
describe("useStorage tests", () => {
  ...
  describe("useLocalStorage tests with no typing", () => {
  ...
  describe("useLocalStorage tests with typing", () => {
    ...
    it("should save and restore value when complexe object is provided (object)", () => {
      ...
      const { result } = renderHook(() => useLocalStorage<User>("user", user));
    ...
    it("should set complexe object when no initial value is provided", () => {
      ...
      const { result } = renderHook(() =>
        useLocalStorage<User | undefined>("users", undefined)
      );
    ...
    it("should set array when no initial value is provided", () => {
      ...
      const { result } = renderHook(() => useLocalStorage<User[]>("users", []));
      const [, setValue] = result.current;
